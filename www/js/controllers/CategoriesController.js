...
.controller('CategoriesController',function($ImageCacheFactory,$scope,CategoryService,$state,$ionicLoading,$ionicSlideBoxDelegate,$timeout,ionicMaterialInk,$rootScope){
  $scope.categories={};
  $ionicLoading.show({
  content: 'Loading',
  animation: 'fade-in',
